<?php
require "../controladores/controladorc.php";
$obj = new Clasec();
$obj->extraerdatos();
$obj->calcularBits();
$obj->nuevaMascara();
...
<head>
    ...
    <title>Calculadora | Clase c</title>
...
<body>
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" style="background-color: #e3f2fd;">
            ...
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../clases/clasec.html">Clase c</a>
            </li>
        </ul>

        <div class="position-absolute top-0 end-0" style="margin-top: 165px; margin-right: 13px;">
            <a class="btn btn-outline-primary" href="../clases/clasec.html" role="button">
            ...
            <table class="table table-bordered border-success" style="margin-top: 50px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo ($obj->getBin1() . "." . $obj->getBin2() . "." . $obj->getBin3() . "." . $obj->getBin4() . " /" . (24 + $obj->getBits()));
                            ?>
                        </td>
                    </tr>
                    <tr>
