<?php
require "../controladores/controladora.php";
$obj = new Clasea();
$obj->extraerdatos();
$obj->calcularBits();
$obj->nuevaMascara();
...
<head>
    ...
    <title>Calculadora | Clase a</title>
...
<body>
    <div class="container-fluid">
        ...
        <ul class="nav nav-tabs" style="background-color: #e3f2fd;">
            <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../clases/clasea.html">Clase a</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="../clases/claseb.html">Clase b</a>
            </li>
            <li class="nav-item">
        ...
        <div class="position-absolute top-0 end-0" style="margin-top: 165px; margin-right: 13px;">
            <a class="btn btn-outline-primary" href="../clases/clasea.html" role="button">
            ...
            <table class="table table-bordered border-success" style="margin-top: 50px;">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            echo ($obj->getBin1() . "." . $obj->getBin2() . "." . $obj->getBin3() . "." . $obj->getBin4() . " /" . (8 + $obj->getBits()));
                            ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    for ($i = 1; $i <= pow(2, $obj->getBits()); $i++) {
                        if ($obj->getBits() <= 8) {
                            if ($i == 1) {
                                ...
                                echo ("<td>" . $l1 . "." . ($l2 += ($obj->getSaltos() - 1)) . "." . 255 . "." . 254 . "</td>");
                                echo ("<td>" . $l1 . "." . $l2 . "." . 255 . "." . 255 . "</td>");
                                echo ("</tr>");
                            } else {
                                echo ("<tr>");
                                echo ('<th scope="row">' . $i . '</th>');
                                echo ("<td>" . $l1 . "." . ($l2 += 1) . "." . $l3 . "." . $l4 . "</td>");
                                echo ("<td>" . $l1 . "." . $l2 . "." . $l3  . "." . ($l4 + 1) . "</td>");
                                echo ("<td>" . $l1 . "." . ($l2 += ($obj->getSaltos() - 1)) . "." . 255 . "." . 254 . "</td>");
                                echo ("<td>" . $l1 . "." . $l2 . "." . 255 . "." . 255 . "</td>");
                                echo ("</tr>");
